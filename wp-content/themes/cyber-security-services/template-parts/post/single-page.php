		...
		<div class="container">
			<div class="content-area my-5">
				<div id="main" class="site-main" role="main">
			       	<div class="row m-0">
			       		<?php if($cyber_security_services_single_post_option == 'single_right_sidebar'){ ?>
									...
									while ( have_posts() ) : the_post(); ?>
										<div id="single-post-section" class="single-post-page entry-content">
											<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
										        ...
										        <?php if( get_option('cyber_security_services_single_post_tag',false) != 'off'){ ?>
							      					<?php if (has_tag()) {
										...
										do_action( 'cyber_security_services_single_post_pagination' );

									endwhile; // End of the loop.
									?>
									<div class="clearfix"></div> 
									<?php if( get_option('cyber_security_services_similar_post',false) != 'off'){ ?>
